...
export default function About() {
  ...
  return (
    <div className="w-full">
      <section className="pt-32 sm:pt-40 pb-20 sm:pb-32 bg-[#171717]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 sm:gap-20 items-center">
            <div className="order-2 lg:order-1">
              ...
              >
                ...
                <h1 className="text-4xl sm:text-5xl md:text-7xl font-serif mb-8 md:mb-10 leading-[1.1] tracking-tight">
                  {sAbout.title1 || 'Detailing'} <br/>
                  <span className="italic text-white/90">{sAbout.title2 || 'Services.'}</span>
                </h1>
                
                <div className="space-y-6 sm:space-y-8 text-[#d1d1d1]/70 font-light leading-relaxed text-base sm:text-lg">
                  <p>
                ...
                <div className="mt-12 sm:mt-16 grid grid-cols-1 sm:grid-cols-3 gap-8 border-t border-white/5 pt-10 sm:pt-12">
                  <div>
                    <Award className="text-white/30 mb-3 sm:mb-4" size={24} sm:size={28} strokeWidth={1.5} />
                    <h4 className="font-serif text-lg sm:text-xl text-white mb-1 sm:mb-2">Certified</h4>
                    <p className="text-[10px] text-[#d1d1d1]/50 uppercase tracking-[0.2em]">{sAbout.certs || 'Koch Chemie USA'}</p>
                  </div>
                  <div>
                    <MapPin className="text-white/30 mb-3 sm:mb-4" size={24} sm:size={28} strokeWidth={1.5} />
                    <h4 className="font-serif text-lg sm:text-xl text-white mb-1 sm:mb-2">Mobile</h4>
                    <p className="text-[10px] text-[#d1d1d1]/50 uppercase tracking-[0.2em]">{settings?.contact?.area || 'Collin County, TX'}</p>
                  </div>
                  <div>
                    <Shield className="text-white/30 mb-3 sm:mb-4" size={24} sm:size={28} strokeWidth={1.5} />
                    <h4 className="font-serif text-lg sm:text-xl text-white mb-1 sm:mb-2">Insured</h4>
            ...
            <div className="order-1 lg:order-2">
              <motion.div
                ...
                className="relative"
              >
                <div className="aspect-[4/5] sm:aspect-video lg:aspect-[3/4] relative overflow-hidden rounded-sm group">
                  <img 
